    ...
    var rgraph = new $jit.RGraph({
	  ...
	  'zooming': 20,
        ...
        onBeforeCompute: function(node){
			...
			if (node.name == "Maeckes") {
			zentrum = 0;
			}
			else if (node.name == "Bartek") {
			zentrum = 1;
			}
			else if (node.name == "Edgar Wasser") {
			zentrum = 2;
			}
			else if (node.name == "Weekend") {
			zentrum = 3;
			}
			else if (node.name == "Kaas") {
			zentrum = 4;
			}
			else if (node.name == "Fatoni") {
			zentrum = 5;
			}
			else if (node.name == "Alligatoah") {
			zentrum = 6;
			}
			else if (node.name == "K.I.Z.") {
			zentrum = 7;
			}
			else if (node.name == "Tua") {
			zentrum = 8;
			}
